$(function(){
    ...
    '<li class="layui-nav-item"><a href="/org/index.html">社区</a></li><li class="layui-nav-item"><a href="/machine/data.html">我的房间</a></li><li class="layui-nav-item"><a href="/machine/bind.html">绑定设备</a></li><li class="layui-nav-item"><a href="/machine/link.html">设备联动</a></li></ul><ul class="layui-nav nav-right" id="nav-right">'+
